...
protocol DoneApplyJobViewDelegate:class {
...
class DoneApplyJobView: UIView {
    ...
    */
    ...
    weak var delegateView:DoneApplyJobViewDelegate? = nil
    ...
    private func setLanguageForView(){
        ...
        self.mButton.setTitle(NSLocalizedString("doneapplyjobview_button_done", comment: ""), for: .normal)
    }
